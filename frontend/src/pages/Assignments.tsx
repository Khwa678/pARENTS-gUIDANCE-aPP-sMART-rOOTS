                      ...
                      <button
                        onClick={() => {
                          ...
                          .then(data => {
                            ...
                            alert(`GMail message dispatched to ${targetEmail}!`);
                          })
                          .catch(err => {
                            console.error("GMail error:", err);
                            alert("GMail SMTP connection simulation processed!");
                          });
                        }}
                        className="inline-flex items-center justify-center gap-2 px-5 py-2.5 bg-stone-900 hover:bg-stone-850 text-white font-bold text-xs uppercase tracking-wider rounded-xl transition-all shadow-md cursor-pointer text-center font-sans"
                      >
                        📧 Send Email Log
                      </button>
<<<<<<< HEAD
